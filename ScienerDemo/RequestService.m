...
#define URL @"http://192.168.31.188:8081/openAPI"
           ...
           accesstoken:(NSString*)accessToken
{
    ...
    if (!errcode) {
        ...
        NSString * lock_key = [resultsDictionary objectForKey:@"lock_key"];
        NSNumber * room_id = [resultsDictionary objectForKey:@"room_id"];
        NSNumber * date = [resultsDictionary objectForKey:@"date"];
        NSNumber * sDate = [resultsDictionary objectForKey:@"start_date"];
        NSNumber * eDate = [resultsDictionary objectForKey:@"end_date"];
...
//        NSData * dynamicNO = [MyUtils EncodeScienerPS:[MyUtils DecodeSharedKeyValue:keyStr]];
        ...
        if (sDate.intValue == 0) {
            ...
            key.startDate = [XYCUtils formateDateFromStringToDate:@"201410101010" format:@"yyyyMMddHHmm"].timeIntervalSince1970;
            key.endDate = [XYCUtils formateDateFromStringToDate:@"202010101010" format:@"yyyyMMddHHmm"].timeIntervalSince1970;
